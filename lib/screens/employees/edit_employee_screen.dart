...
class _EditEmployeeScreenState extends State<EditEmployeeScreen> {
  ...
  late String _selectedPayoutCurrency;
  late EmploymentType _selectedEmploymentType;
  ...
  void initState() {
    ...
    _departmentOptions = _buildDepartmentOptions(widget.employee.department);
    _selectedDepartment = _departmentOptions.first;
    final rawStatus = widget.employee.status.trim().toLowerCase();
    _selectedStatus = _statusOptions.contains(rawStatus)
        ? rawStatus
        : _statusOptions.first;
    _selectedPayoutCurrency = widget.employee.payoutCurrency;
    _selectedEmploymentType = widget.employee.employmentType;
    _hireDate = widget.employee.hireDate;
    _probationEndDate = widget.employee.probationEndDate;
    _contractEndDate = widget.employee.contractEndDate;
    _isProbationConfirmed = widget.employee.isProbationConfirmed;
  }

  List<String> _buildDepartmentOptions(String currentDepartment) {
    final unique = <String>{};
    final options = <String>[];

    for (final dept in AppStrings.departments) {
    ...
    final current = currentDepartment.trim();
    if (current.isNotEmpty && !unique.contains(current)) {
  ...
  Future<void> _updateEmployee() async {
    ...
    NotificationHelper.showLoading(context, message: 'Updating employee...');
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      topBar: AppBar(title: const Text('Edit Employee')),
